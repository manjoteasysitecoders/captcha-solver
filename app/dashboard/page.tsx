  ...
  return (
    <div className="space-y-6">
      ...
      {(isFreePlan || user.credits < 10) && (
        <section className="relative rounded-3xl border border-primary/50 bg-primary/10 p-8 shadow-sm">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
            ...
            <div className="space-y-4 max-w-xl">
              ...
              <p className="text-foreground/70">
                Upgrade your plan to unlock higher daily limits, faster solving,
                and uninterrupted usage as you scale.
              </p>
            </div>
